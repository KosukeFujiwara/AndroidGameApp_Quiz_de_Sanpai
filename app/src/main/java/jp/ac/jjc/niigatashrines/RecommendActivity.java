...
public class RecommendActivity extends AppCompatActivity {
    ...
    final String[] recommendText = {"越後国一宮の一つで、初詣の参拝者数は県内トップ。御祭神は天照大神の曾孫の天香山命（あめのかごやまのみこと）で、創建は紀元前という、古くて格式高い神社。万葉集にも登場。弥彦山山頂には奥宮もある。",
                ...
                "天津神社は越後国一宮で、春の大祭にて奉納される舞楽は、国の重要無形民俗文化財に指定されている。境内社として奴奈川神社もある。糸魚川といえば翡翠、翡翠といえば奴奈川姫です。",
                ...
                "奈良の春日大社より分霊され、春日大社の記録では、全国の春日神社の中で最初に出てくる。当初は春日山山頂に創建されるが、春日山城築城の際に城の鬼門の位置に遷座、現在に至る。2020年4月、約200年ぶりに建て替えられて綺麗に。",
                "読みは「いするぎじんじゃ」。錦鯉と牛の角突きの天井画がある。オリジナル御朱印帳が特徴的。現在の外見はあまり神社っぽくなく、一軒家と一体化したような形態となっている。",
